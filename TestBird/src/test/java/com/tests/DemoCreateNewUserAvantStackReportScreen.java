...
public class DemoCreateNewUserAvantStackReportScreen extends Base {
	DashboardPage dp;
	UsresPage up;
	LoginPage lp;
	CreateUser cu;
	...
	public DemoCreateNewUserAvantStackReportScreen() throws IOException {
		super();
		initiation();
...
//	static String url = "https://opensource-demo2.orangehrmlive.com/index.php/auth/login";
	...
	public void createNewUserTest() throws InterruptedException, IOException {
		try {
			...
			test = extent.createTest("createNewUserTest", "PASSED test case");
			lp = new LoginPage();
