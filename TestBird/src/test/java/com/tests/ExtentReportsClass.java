...
public class ExtentReportsClass {
	...
	public void startReport() {
		...
		extent.addSystemInfo("Host Name", "iqst").addSystemInfo("Environment", "Automation Testing")
	...
	public void failTest() {
		...
		// getScreenshot method and captures a screenshot and place it in the extent
		// reports
